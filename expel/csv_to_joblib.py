...
csv_file_path = '/home/luke-skywalker/github/coa-model/expel/coa-query-small-sample.csv'
df = pd.read_csv(csv_file_path)

# Step 2: Save the DataFrame as a joblib object
joblib_file_path = '/home/luke-skywalker/github/coa-model/expel/coa-query-small-sample.joblib'
